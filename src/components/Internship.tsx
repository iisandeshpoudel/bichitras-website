      ...
      <div className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {careerFields.map((field, index) => (
            <div 
              key={index}
              className="p-6 rounded-xl glass-card gradient-border hover:scale-[1.02] transition-transform duration-300"
            >
              <div className="mb-6 p-3 bg-white/5 rounded-lg w-fit">{field.icon}</div>
              <h3 className="text-2xl font-bold mb-3">{field.title}</h3>
              <p className="text-[var(--text-secondary)] mb-4">{field.description}</p>
