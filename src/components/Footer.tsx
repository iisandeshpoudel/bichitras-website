        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/#services" className="text-royal-celestial/80 hover:text-white transition-colors duration-200">
                  Digital Marketing
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/#about" className="text-royal-celestial/80 hover:text-white transition-colors duration-200">
                  About Us
                </a>
              </li>
              <li>
                <a href="/internship" className="text-royal-celestial/80 hover:text-white transition-colors duration-200">
                  Internships
                </a>
              </li>
              <li>
                <a href="/blog" className="text-royal-celestial/80 hover:text-white transition-colors duration-200">
                  Blog
                </a>
              </li>
              <li>
                <a href="/#contact" className="text-royal-celestial/80 hover:text-white transition-colors duration-200">
                  Contact
                </a>
              </li>
            </ul>
