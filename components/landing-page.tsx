        ...
        <header className="w-full px-8 lg:px-12 h-20 flex items-center justify-center backdrop-blur-md bg-gray-800/30 sticky top-0 z-50">
          <div className="container flex items-center justify-between max-w-7xl mx-auto">
            ...
            <Link 
              ...
              href="#"
            >
              <Zap className="h-8 w-8" /> {/* Increased from h-7 w-7 */}
              <span className="ml-1 text-3xl font-bold tracking-tight"> {/* Increased from text-2xl */}
                Bichitras
              </span>
            </Link>
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-br from-purple-900 to-gray-900 relative overflow-hidden">
            ...
            >
              <div className="flex flex-col items-center space-y-4 text-center">
                <motion.h1 
                  className="premium-text text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none flex flex-col items-center gap-4"
                  variants={fadeIn}
                >
                  <span 
                    className={`font-extrabold text-5xl sm:text-6xl md:text-7xl ${montserrat.className}`}
                    style={{
                      background: 'linear-gradient(to right, #fff 20%, #e2e8f0 30%, #fff 70%)',
                      WebkitBackgroundClip: 'text',
                      backgroundClip: 'text',
                      backgroundSize: '200% auto',
                      color: 'transparent',
                      animation: 'shimmer 8s ease-in-out infinite',
                      textShadow: '0 0 80px rgba(147, 51, 234, 0.15)'
                    }}
                  >
                    Bichitras
                  </span>
                  <span 
                    className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light tracking-wide ${montserrat.className}`}
                    style={{
